	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`,blending:2,depthTest:!1,depthWrite:!1,transparent:!0})}};rf.BlurDirectionX=new B(1,0),rf.BlurDirectionY=new B(0,1);function af(e){let t=new ku({canvas:e,antialias:!0,alpha:!1});t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.setSize(window.innerWidth,window.innerHeight),t.outputColorSpace=Ge,t.toneMapping=4,t.toneMappingExposure=.9,t.shadowMap.enabled=!1;let n=new Vn;n.background=new G(329738),n.fog=new Bn(329738,.035);let r=new Io(5792611,.25),i=new Fo(16774358,.6);i.position.set(4,9,6),n.add(r,i);let a=null,o=null,s=null;function c(e){if(a){o.camera=e,s.renderCamera=e;return}let r=new B(window.innerWidth,window.innerHeight);a=new $d(t),o=new ef(n,e);let i=new nf(r,.3,.35,1.45);s=new rf(r,n,e),s.edgeStrength=3,s.edgeGlow=.35,s.edgeThickness=1.3,s.visibleEdgeColor.set(7143363),s.hiddenEdgeColor.set(1588535),a.addPass(o),a.addPass(i),a.addPass(s)}return{renderer:t,scene:n,resize:e=>{t.setSize(window.innerWidth,window.innerHeight),a&&a.setSize(window.innerWidth,window.innerHeight),e&&(e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix())},render:e=>{c(e),a.render()},setOutlineObjects:(e=[])=>{s&&(s.selectedObjects=e.filter(Boolean))}}}var X=1.25,of=2.4,sf=.6,cf=.4;4.25*X;var lf=9.8,uf=.72,df=.18;1.6*X;var ff=.8,pf=.85,mf=.04,hf={white:{hex:16777215,rgb:{r:1,g:1,b:1},icon:`◇`,iconName:`diamond`},red:{hex:13983232,rgb:{r:.835,g:.369,b:0},icon:`▲`,iconName:`triangle`},green:{hex:40563,rgb:{r:0,g:.62,b:.451},icon:`■`,iconName:`square`},blue:{hex:29362,rgb:{r:0,g:.447,b:.698},icon:`●`,iconName:`circle`},orange:{hex:15113984,rgb:{r:.902,g:.624,b:0},icon:`◆`,iconName:`diamondFilled`}},gf=[`DIRECT_ONLY`,`BOUNCE1`,`BOUNCE2`,`GI`],_f=[`FINAL`,`DIRECT`,`BOUNCE1`,`BOUNCE2`];function vf(e,t,n){return Math.max(t,Math.min(n,e))}function yf(e){return`${e.x},${e.z}`}function bf(e,t){return!!e&&!!t&&e.x===t.x&&e.z===t.z}function xf(e,t,n=0){return{x:(e.x-t.width/2)*X,y:n,z:(e.z-t.height/2)*X}}function Sf(e,t,n){return{x:e/X+n.width/2,z:t/X+n.height/2}}function Cf(e,t,n){return{x:Math.round(e/X+n.width/2),z:Math.round(t/X+n.height/2)}}function wf(e,t){let n=xf(e,t,0),r=X*.5;return{minX:n.x-r,maxX:n.x+r,minZ:n.z-r,maxZ:n.z+r}}function Tf(e,t){return{x:e.x-t.x,y:e.y-t.y,z:e.z-t.z}}function Ef(e,t){return e.x*t.x+e.y*t.y+e.z*t.z}function Df(e){return Ef(e,e)}function Of(e,t){return Df(Tf(e,t))}function kf(e){let t=Math.sqrt(Df(e));return t<1e-8?{x:0,y:0,z:0}:{x:e.x/t,y:e.y/t,z:e.z/t}}function Af(e=0,t=0,n=0){return{r:e,g:t,b:n}}function jf(e){return{r:(e>>16&255)/255,g:(e>>8&255)/255,b:(e&255)/255}}function Mf(e){return{r:e.r,g:e.g,b:e.b}}function Nf(e,t){return e.r+=t.r,e.g+=t.g,e.b+=t.b,e}function Pf(e,t){return{r:e.r*t,g:e.g*t,b:e.b*t}}function Ff(e,t){return{r:e.r*t.r,g:e.g*t.g,b:e.b*t.b}}function If(e){return e.r=0,e.g=0,e.b=0,e}function Lf(e){return .2126*e.r+.7152*e.g+.0722*e.b}function Rf(e){let t=Math.max(e.r,e.g,e.b);return(t-Math.min(e.r,e.g,e.b))/Math.max(t,1e-4)}function zf(e,t){let n=Math.hypot(e.r,e.g,e.b),r=Math.hypot(t.r,t.g,t.b);return n<1e-6||r<1e-6?0:(e.r*t.r+e.g*t.g+e.b*t.b)/(n*r)}function Bf(e,t){return Lf(e)>=.6&&Rf(e)>=.35&&zf(e,t)>=.88}function Vf(e,t,n){return(t.z-e.z)*(n.x-t.x)-(t.x-e.x)*(n.z-t.z)}function Hf(e,t,n){return Math.min(e.x,n.x)-1e-6<=t.x&&t.x<=Math.max(e.x,n.x)+1e-6&&Math.min(e.z,n.z)-1e-6<=t.z&&t.z<=Math.max(e.z,n.z)+1e-6}function Uf(e,t,n,r){let i=Vf(e,t,n),a=Vf(e,t,r),o=Vf(n,r,e),s=Vf(n,r,t);return Math.abs(i)<1e-8&&Hf(e,n,t)||Math.abs(a)<1e-8&&Hf(e,r,t)||Math.abs(o)<1e-8&&Hf(n,e,r)||Math.abs(s)<1e-8&&Hf(n,t,r)?!0:i>0!=a>0&&o>0!=s>0}function Wf(e){return JSON.parse(JSON.stringify(e))}var Gf=[`fp`,`peek`,`third`],Kf=1.6,qf=.002,Jf=1.55,Yf=1200,Xf=class{constructor(e){this.canvas=e,this.camera=new Oo(70,window.innerWidth/window.innerHeight,.1,1e3),this.mode=`fp`,this.yaw=-Math.PI/2,this.pitch=-.1,this.position=new V,this.look=new V,this.euler=new mn(0,0,0,`YXZ`),this.matrix=new W,this.forward=new V(1,0,0),this.right=new V(0,0,1),this.lockPending=!1,this.lastPointerLockFailureMs=-1/0,window.addEventListener(`mousemove`,e=>this.onMouseMove(e)),document.addEventListener(`pointerlockchange`,()=>this.onPointerLockChange()),document.addEventListener(`pointerlockerror`,()=>this.notePointerLockFailure())}get isLocked(){return document.pointerLockElement===this.canvas}get pointerLockUnavailable(){return performance.now()-this.lastPointerLockFailureMs<Yf}shouldRequestLock(){return!this.isLocked&&!this.lockPending&&!this.pointerLockUnavailable&&typeof this.canvas.requestPointerLock==`function`}notePointerLockFailure(){this.lastPointerLockFailureMs=performance.now(),this.lockPending=!1}onPointerLockChange(){this.isLocked&&(this.lastPointerLockFailureMs=-1/0,this.lockPending=!1)}lock(){if(!this.shouldRequestLock())return!1;let e=this.canvas.requestPointerLock();return this.lockPending=!0,e?.then?(e.then(()=>this.onPointerLockChange()).catch(()=>this.notePointerLockFailure()).finally(()=>{this.isLocked||(this.lockPending=!1)}),!0):(this.lockPending=!1,!0)}unlock(){this.isLocked&&document.exitPointerLock?.()}onMouseMove(e){!this.isLocked||this.mode!==`fp`||(this.yaw-=e.movementX*qf,this.pitch=Math.max(-1.55,Math.min(Jf,this.pitch-e.movementY*qf)))}setMode(e){e===`top`||e===`chase`||e===`close`?this.mode=`fp`:Gf.includes(e)&&(this.mode=e)}setYawPitch(e,t=this.pitch){this.yaw=e,this.pitch=Math.max(-1.55,Math.min(Jf,t))}toggleThird(){this.mode=this.mode===`third`?`fp`:`third`}togglePeek(){this.mode=this.mode===`peek`?`fp`:`peek`}getForwardXZ(){return{x:-Math.sin(this.yaw),z:-Math.cos(this.yaw)}}getRightXZ(){return{x:Math.cos(this.yaw),z:-Math.sin(this.yaw)}}applyFp(e){this.camera.up.set(0,1,0),this.camera.position.set(e.position.x,e.position.y+Kf,e.position.z),this.euler.set(this.pitch,this.yaw,0),this.camera.quaternion.setFromEuler(this.euler)}applyPeek(e){let t=xf({x:(e.width-1)/2,z:(e.height-1)/2},e,.35),n=Math.max(e.width,e.height)*X,r=new V(t.x,Math.max(9,n*1.05),t.z+.01);this.camera.up.set(0,0,-1),this.camera.position.copy(r),this.matrix.lookAt(r,new V(t.x,.35,t.z),this.camera.up),this.camera.quaternion.setFromRotationMatrix(this.matrix)}applyThird(e,t){let n=this.getForwardXZ(),r=this.getRightXZ(),i=new V(t.position.x,t.position.y+.72,t.position.z),a=new V(t.position.x-n.x*2.2+r.x*2.7,t.position.y+1.55,t.position.z-n.z*2.2+r.z*2.7),o=(1-e.width/2)*X+.35,s=(e.width-2-e.width/2)*X-.35,c=(1-e.height/2)*X+.35,l=(e.height-2-e.height/2)*X-.35;a.x=vf(a.x,o,s),a.z=vf(a.z,c,l),a.distanceTo(i)<1.9&&(a.y+=.75),this.camera.up.set(0,1,0),this.camera.position.copy(a),this.matrix.lookAt(a,i,this.camera.up),this.camera.quaternion.setFromRotationMatrix(this.matrix)}snapTo(e,t){this.update(e,t)}update(e,t){this.mode===`peek`?this.applyPeek(e):this.mode===`third`?this.applyThird(e,t):this.applyFp(t)}},Zf=new Map([[`w`,{x:0,z:-1}],[`arrowup`,{x:0,z:-1}],[`s`,{x:0,z:1}],[`arrowdown`,{x:0,z:1}],[`a`,{x:-1,z:0}],[`arrowleft`,{x:-1,z:0}],[`d`,{x:1,z:0}],[`arrowright`,{x:1,z:0}]]),Qf=class{constructor(e=window,t={}){this.canvas=e,this.onPointerDownCapture=t.onPointerDown??null,this.down=new Set,this.moveBuffer=[],this.actions=[],window.addEventListener(`keydown`,e=>this.onKey(e)),window.addEventListener(`keyup`,e=>this.down.delete(e.key.toLowerCase())),this.canvas.addEventListener?.(`pointerdown`,e=>this.onPointerDown(e))}onKey(e){let t=e.key.toLowerCase();(Zf.has(t)||[`e`,`q`,`z`,`r`,`g`,`b`,`m`,`t`,`p`,`o`,`f`,`f1`,`v`,`n`,`c`,`escape`].includes(t))&&e.preventDefault(),this.down.add(t);let n=performance.now();Zf.has(t)&&!e.repeat&&this.moveBuffer.push({dir:Zf.get(t),at:n}),e.repeat||this.actions.push({key:t,at:n})}onPointerDown(e){e.button===0&&this.onPointerDownCapture?.(e)!==!0&&this.actions.push({key:`mouse0`,at:performance.now()})}poll(){let e=performance.now()-100;this.moveBuffer=this.moveBuffer.filter(t=>t.at>=e),this.actions=this.actions.filter(t=>t.at>=e)}consumeMove(){return this.poll(),this.moveBuffer.shift()?.dir??null}consumeAction(e){this.poll();let t=this.actions.findIndex(t=>t.key===e);return t===-1?!1:(this.actions.splice(t,1),!0)}isDown(e){return this.down.has(e.toLowerCase())}movementAxes(){return{forward:(this.isDown(`w`)||this.isDown(`arrowup`)?1:0)-(this.isDown(`s`)||this.isDown(`arrowdown`)?1:0),right:(this.isDown(`d`)||this.isDown(`arrowright`)?1:0)-(this.isDown(`a`)||this.isDown(`arrowleft`)?1:0)}}},$f=[{id:1,name:`First Light`,width:8,height:4,start:{x:1,z:1},exit:{x:6,z:1},interiorWalls:[],blocks:[{id:`b1`,spawnCell:{x:2,z:1},colorKey:`white`,state:`pickup`,on:!0}],sockets:[{id:`s1`,cell:{x:4,z:1}}],bouncePanels:[],gates:[],cameraStart:`top`,objective:`블록을 소켓에 놓아 출구까지 길을 켜라.`,expectedSolution:[`(2,1)에서 b1 픽업`,`(4,1) 소켓에 배치`,`(5,1) 점등 → 출구(6,1) 도달`],validateAsserts:[{mode:`GI`,afterPlace:[],cell:{x:5,z:1},expected:!1},{mode:`GI`,afterPlace:[[`b1`,`s1`]],cell:{x:5,z:1},expected:!0}]},{id:2,name:`Around the Corner`,width:7,height:6,start:{x:1,z:1},exit:{x:1,z:4},interiorWalls:[{x:1,z:2},{x:2,z:2},{x:3,z:2},{x:4,z:2}],blocks:[{id:`b1`,spawnCell:{x:2,z:1},colorKey:`white`,state:`pickup`,on:!0}],sockets:[{id:`s1`,cell:{x:5,z:1}}],bouncePanels:[{id:`w1`,cells:[{x:1,z:5},{x:2,z:5},{x:3,z:5},{x:4,z:5}],normal:`-z`,albedo:15921382}],gates:[],cameraStart:`top`,objective:`정면은 막혔다. 빛을 벽에 튕겨 코너 뒤를 켜라.`,expectedSolution:[`b1 픽업`,`(5,1) 배치`,`연결통로(5,2) 하강`,`W가 (2,4) 등 entry 타일로 bounce → 출구(1,4)`],validateAsserts:[{mode:`DIRECT_ONLY`,afterPlace:[[`b1`,`s1`]],cell:{x:2,z:4},expected:!1},{mode:`GI`,afterPlace:[[`b1`,`s1`]],cell:{x:2,z:4},expected:!0}]},{id:3,name:`Long Throw`,width:11,height:5,start:{x:1,z:1},exit:{x:10,z:3},interiorWalls:[],blocks:[{id:`b1`,spawnCell:{x:2,z:1},colorKey:`white`,state:`pickup`,on:!0}],sockets:[{id:`s1`,cell:{x:4,z:1}}],bouncePanels:[{id:`w1`,cells:[{x:9,z:2}],normal:`-z`,albedo:15921382},{id:`w2`,cells:[{x:8,z:2}],normal:`-x`,albedo:15921382}],gates:[],cameraStart:`top`,objective:`멀다. 한 번이 아니라 두 번 튕겨야 닿는다.`,expectedSolution:[`b1 (4,1) 배치`,`W1→W2 2차 bounce로 (9,3) 점등`,`출구(10,3) 도달`],validateAsserts:[{mode:`BOUNCE1`,afterPlace:[[`b1`,`s1`]],cell:{x:9,z:3},expected:!1},{mode:`GI`,afterPlace:[[`b1`,`s1`]],cell:{x:9,z:3},expected:!0}]},{id:4,name:`Meet in the Middle`,width:9,height:6,start:{x:1,z:3},exit:{x:7,z:3},interiorWalls:[],blocks:[{id:`b1`,spawnCell:{x:2,z:3},colorKey:`white`,state:`pickup`,on:!0},{id:`b2`,spawnCell:{x:3,z:3},colorKey:`white`,state:`pickup`,on:!0}],sockets:[{id:`s1`,cell:{x:3,z:1}},{id:`s2`,cell:{x:5,z:1}}],bouncePanels:[],gates:[],cameraStart:`top`,objective:`한 빛으로는 부족하다. 두 빛을 겹쳐라.`,expectedSolution:[`b1→s1, b2→s2 배치`,`(4,3)가 가산으로 점등 → 출구`],validateAsserts:[{mode:`GI`,afterPlace:[[`b1`,`s1`]],cell:{x:4,z:3},expected:!1},{mode:`GI`,afterPlace:[[`b1`,`s1`],[`b2`,`s2`]],cell:{x:4,z:3},expected:!0}]},{id:5,name:`Afterglow`,width:11,height:5,start:{x:1,z:1},exit:{x:10,z:4},interiorWalls:[],blocks:[{id:`b1`,spawnCell:{x:2,z:1},colorKey:`white`,state:`pickup`,on:!0},{id:`b2`,spawnCell:{x:3,z:1},colorKey:`green`,state:`pickup`,on:!0}],sockets:[{id:`s1`,cell:{x:4,z:1}},{id:`s2`,cell:{x:9,z:2}}],bouncePanels:[{id:`w1`,cells:[{x:5,z:3}],normal:`+z`,albedo:15921382}],gates:[{cell:{x:9,z:3},gateColor:`green`,icon:`square`}],cameraStart:`chase`,objective:`마지막 문은 초록 빛이 필요하다.`,expectedSolution:[`b1(white) s1 배치로 본 경로 점등`,`b2(green) s2 배치`,`g(9,3) hueMatch → open → 출구(10,4)`],validateAsserts:[{mode:`GI`,afterPlace:[[`b1`,`s1`]],cell:{x:9,z:3},expected:!1},{mode:`GI`,afterPlace:[[`b1`,`s1`],[`b2`,`s2`]],cell:{x:9,z:3},expected:!0}]}];function ep(e,t,n,r){let i=xf(t,n,mf),a=r?`gate`:`floor`,o=(n.blocks??[]).some(e=>bf(e.spawnCell,t));return{id:e,cell:{...t},pos:i,normal:{x:0,y:1,z:0},type:a,albedo:Af(.54,.52,.47),direct:Af(),directPlaced:Af(),directCarried:Af(),bounce1:Af(),bounce2:Af(),irradiance:Af(),visualIrradiance:Af(),walkable:!1,wasWalkable:!1,alwaysSolid:bf(t,n.start)||bf(t,n.exit)||o,gateColor:r?.gateColor??null,icon:r?.icon??null,uvRect:{u:0,v:0,w:1,h:1}}}function tp(e){let t=new Set(e.interiorWalls.map(yf)),n=new Map((e.gates??[]).map(e=>[yf(e.cell),e])),r=[],i=[],a=new Map,o=0;for(let s=0;s<e.height;s++)for(let c=0;c<e.width;c++){let l={x:c,z:s},u=bf(l,e.start)||bf(l,e.exit)||n.has(yf(l));if(!(c>0&&c<e.width-1&&s>0&&s<e.height-1)&&!u||t.has(yf(l)))continue;let d=ep(`f${o++}`,l,e,n.get(yf(l)));d.gateColor&&hf[d.gateColor]&&(d.albedo=jf(hf[d.gateColor].hex)),r.push(d),i.push(d),a.set(yf(l),d)}return{width:e.width,height:e.height,surfels:r,floorSurfels:r,tiles:i,tileAt(e){return a.get(yf(e))??null},byKey:a}}function np(e){return e===`+x`?{x:1,y:0,z:0}:e===`-x`?{x:-1,y:0,z:0}:e===`+z`?{x:0,y:0,z:1}:{x:0,y:0,z:-1}}function rp(e,t){let n=xf(e,t,0),r=X*.5;return{left:n.x-r,right:n.x+r,top:n.z-r,bottom:n.z+r}}function ip(e,t,n,r){let i=rp(t,n);e.push({id:`${r}-n`,a:{x:i.left,z:i.top},b:{x:i.right,z:i.top},blocksVisibility:!0}),e.push({id:`${r}-s`,a:{x:i.left,z:i.bottom},b:{x:i.right,z:i.bottom},blocksVisibility:!0}),e.push({id:`${r}-w`,a:{x:i.left,z:i.top},b:{x:i.left,z:i.bottom},blocksVisibility:!0}),e.push({id:`${r}-e`,a:{x:i.right,z:i.top},b:{x:i.right,z:i.bottom},blocksVisibility:!0})}function ap(e){let t=[],n=[],r=new Set;for(let n of e.interiorWalls)ip(t,n,e,`i-${n.x}-${n.z}`);for(let t of e.bouncePanels??[]){let i=np(t.normal);for(let a of t.cells){r.add(yf(a));let o=xf(a,e,1),s=X*.46,c={x:o.x-i.x*s,y:o.y,z:o.z-i.z*s};n.push({id:`${t.id}-${a.x}-${a.z}`,panelId:t.id,cell:{...a},pos:c,normal:i,type:`wall`,albedo:jf(t.albedo),direct:{r:0,g:0,b:0},directPlaced:{r:0,g:0,b:0},directCarried:{r:0,g:0,b:0},bounce1:{r:0,g:0,b:0},bounce2:{r:0,g:0,b:0},irradiance:{r:0,g:0,b:0},visualIrradiance:{r:0,g:0,b:0},walkable:!1,wasWalkable:!1,blocksVisibility:!1})}}return{walls:t,wallSurfels:n,panelCellKeys:r}}function op(e,t){let n=Ef(e.normal,t);return e.type===`wall`?Math.abs(n):Math.max(0,n)}function sp(e,t){let n=kf(Tf(t.pos,e.pos)),r={x:-n.x,y:-n.y,z:-n.z},i=op(e,n),a=op(t,r),o=Math.max(Of(e.pos,t.pos),.25);return i*a/(Math.PI*o)}function cp(e,t,n){let r={x:e.x,z:e.z},i={x:t.x,z:t.z};for(let e of n)if(e.blocksVisibility&&Uf(r,i,e.a,e.b))return!1;return!0}var lp=X*X;function up(e){return hf[e.colorKey]?.rgb??hf.white.rgb}function dp(e){return e.colorKey===`white`?17:19}function fp(e,t){return e.state===`placed`&&e.cell?xf(e.cell,t,pf):e.state===`carried`&&t.playerCell?xf(t.playerCell,t,pf):null}function pp(e){return e.surfels}function mp(e){If(e.direct),If(e.directPlaced),If(e.directCarried),If(e.bounce1),If(e.bounce2),If(e.irradiance)}function hp(e,t,n,r){let i=fp(t,n);if(!i||t.state===`carried`&&Math.sqrt(Of(i,e.pos))>2||e.type!==`wall`&&!cp(i,e.pos,n.walls))return;let a=kf(Tf(i,e.pos)),o=Ef(e.normal,a),s=e.type===`wall`?Math.max(.08,Math.abs(o)):Math.max(0,o);if(s<=0)return;let c=Math.max(Of(i,e.pos),.25),l=dp(t)*(t.state===`carried`?ff:1);Nf(r,Pf(up(t),l*s/c))}function gp(e){for(let t of pp(e)){for(let n of e.blocks)!n.on||![`placed`,`carried`].includes(n.state)||(n.state===`placed`&&hp(t,n,e,t.directPlaced),n.state===`carried`&&hp(t,n,e,t.directCarried));t.direct.r=t.directPlaced.r+t.directCarried.r,t.direct.g=t.directPlaced.g+t.directCarried.g,t.direct.b=t.directPlaced.b+t.directCarried.b}}function _p(e,t){return t===1?e.directPlaced:{r:e.directPlaced.r+e.bounce1.r,g:e.directPlaced.g+e.bounce1.g,b:e.directPlaced.b+e.bounce1.b}}function vp(e,t){e.r*=t,e.g*=t,e.b*=t}function yp(e,t){if(t===1){let t=Lf(e.bounce1);t>.72&&vp(e.bounce1,uf/t);return}let n=Lf(e.bounce1),r=Math.max(0,uf-n),i=Lf(e.bounce2);i>r&&vp(e.bounce2,r/i)}function bp(e,t){let n=t===1?`bounce1`:`bounce2`;for(let r of pp(e)){for(let i of pp(e)){if(i===r||Of(r.pos,i.pos)>5.3125*5.3125||!cp(r.pos,i.pos,e.walls))continue;let a=_p(i,t);if(Lf(a)<.001)continue;let o=sp(r,i);o<=0||Nf(r[n],Pf(Ff(i.albedo,a),o*lp*lf))}yp(r,t)}}function xp(e,t){if(t===`VISUAL_OFF`)return Af();let n=Mf(e.direct);return t===`DIRECT_ONLY`||(Nf(n,e.bounce1),t===`BOUNCE1`)||Nf(n,e.bounce2),n}function Sp(e){if(e.wasWalkable=e.walkable,e.type===`wall`){e.walkable=!1;return}if(e.alwaysSolid){e.walkable=!0;return}let t=Lf(e.irradiance),n=e.walkable?t>=cf:t>=sf;e.gateColor&&(n=Bf(e.irradiance,hf[e.gateColor].rgb)),e.walkable=n}function Cp(e,t=e.mode??`GI`){let n=performance.now?.()??Date.now();for(let t of pp(e))mp(t);gp(e),bp(e,1),bp(e,2);for(let n of pp(e)){let e=xp(n,t);n.irradiance=e,n.visualIrradiance.r+=(e.r-n.visualIrradiance.r)*df,n.visualIrradiance.g+=(e.g-n.visualIrradiance.g)*df,n.visualIrradiance.b+=(e.b-n.visualIrradiance.b)*df,Sp(n)}return e.mode=t,e.lastSolveMs=(performance.now?.()??Date.now())-n,e}function wp(e){let t=Wf(e),n=tp(t),r=ap(t),i=t.blocks.map(e=>({...e,initialColorKey:e.colorKey,cell:null,holder:null})),a={...t,grid:n,walls:r.walls,wallSurfels:r.wallSurfels,surfels:[...n.surfels,...r.wallSurfels],blocks:i,playerCell:{...t.start},mode:`GI`,lastSolveMs:0};return Cp(a,`GI`),a}function Tp(e){for(let t of e.blocks)t.state=`pickup`,t.cell=null,t.holder=null,t.colorKey=t.initialColorKey??t.colorKey}function Ep(e,t,n){let r=e.blocks.find(e=>e.id===t),i=e.sockets.find(e=>e.id===n);if(!r||!i)throw Error(`Missing block/socket ${t}/${n}`);return r.state=`placed`,r.cell={...i.cell},r.holder=null,r}function Dp(e,t){let n=e.grid.tileAt(t),r=bf(t,e.exit)||Math.max(Math.abs(t.x-e.exit.x),Math.abs(t.z-e.exit.z))<=1;return{tile:n,walkable:!!n?.walkable,reachedExit:r,luminance:n?n.irradiance:{r:0,g:0,b:0}}}var Op=Object.freeze({SOLID:`SOLID`,VOID:`VOID`}),kp=100;function Ap(e,t,n){return Sf(t,n,e)}function jp(e,t,n){let r=e.grid.tileAt({x:t,z:n});return!r||r.type===`wall`?0:r.alwaysSolid?Math.max(sf,Lf(r.irradiance)):Lf(r.irradiance)}function Mp(e,t,n){let r=Ap(e,t,n),i=Math.floor(r.x),a=Math.floor(r.z),o=i+1,s=a+1,c=vf(r.x-i,0,1),l=vf(r.z-a,0,1),u=jp(e,i,a),d=jp(e,o,a),f=jp(e,i,s),p=jp(e,o,s),m=u+(d-u)*c;return m+(f+(p-f)*c-m)*l}function Np(e,t,n,r){let i=e===Op.SOLID?Op.SOLID:Op.VOID,a=Mp(t,n,r);return i===Op.VOID&&a>=.6?Op.SOLID:i===Op.SOLID&&a<=.4?Op.VOID:i}function Pp(e=Op.VOID){return{state:e,pendingState:e,pendingMs:0,coyoteMs:e===Op.SOLID?kp:0,luminance:0}}function Fp(e,t,n,r,i){let a=Np(e.state,t,n,r),o=Mp(t,n,r),s=e.state,c=e.pendingState,l=e.pendingMs;a===e.state?(c=e.state,l=0):(c=a,l=c===e.pendingState?l+i:i,l>=120&&(s=a,l=0));let u=s===Op.SOLID?kp:Math.max(0,e.coyoteMs-i);return{state:s,pendingState:c,pendingMs:l,coyoteMs:u,luminance:o,supported:s===Op.SOLID||u>0}}function Ip(e,t){let n=new pa(X*.92,.08,X*.92),r=new K(n,t.voidTile.clone());r.position.set(e.pos.x,-.04,e.pos.z),r.userData.surfelId=e.id,r.userData.tileState=`void`,r.userData.transitionTimer=0;let i=new $i(new xa(n),new Vi({color:16770723,transparent:!0,opacity:.35}));return i.position.copy(r.position),i.position.y+=.05,i.userData.edgeFor=e.id,{mesh:r,edge:i}}function Lp(e,t,n){let{mesh:r,edge:i}=e,a=t.gateColor&&!t.walkable?`gateLocked`:t.gateColor&&t.walkable?`gateOpen`:t.walkable?`solid`:t.wasWalkable?`fading`:`void`;a!==r.userData.tileState&&(r.userData.tileState=a,r.userData.transitionTimer=400),r.userData.transitionTimer=Math.max(0,r.userData.transitionTimer-n);let o=Lf(t.visualIrradiance),s=t.visualIrradiance;r.material.color.setRGB(a===`void`?.04:Math.min(.35+s.r*.18,1),a===`void`?.055:Math.min(.36+s.g*.18,1),a===`void`?.06:Math.min(.34+s.b*.18,1)),r.material.emissive.setRGB(Math.min(s.r*.22,1),Math.min(s.g*.22,1),Math.min(s.b*.22,1)),r.material.emissiveIntensity=Math.min(o,1.8),r.material.opacity=a===`void`?.48:1,i.visible=a!==`void`,i.material.opacity=a===`fading`?.75:a===`gateLocked`?.25:.55}function Rp(e){let t=[];for(let n=0;n<4;n++){let n=new Mo(16777215,0,7);n.castShadow=!1,e.add(n),t.push(n)}return t}function zp(e,t,n=16){for(let r of e.grid.surfels){let e=t.tileBySurfel.get(r.id);e&&Lp(e,r,n)}let r=e.blocks.filter(e=>e.state===`placed`&&e.cell).slice(0,4);return t.lights.forEach((e,n)=>{let i=r[n];if(!i){e.intensity=0;return}let a=t.blockMeshes.get(i.id);a&&e.position.copy(a.position).add(new V(0,.55,0)),e.color.setHex(t.paletteHex(i.colorKey)),e.intensity=2.2}),t.debugText=`surfels ${e.surfels.length}\nwalkable ${e.grid.surfels.filter(e=>e.walkable).length}\nsolve ${e.lastSolveMs.toFixed(2)}ms`,e.grid.surfels.reduce((e,t)=>e+Lf(t.irradiance),0)}var Bp=class{constructor(e){this.group=new Mn,this.group.visible=!1,this.showSurfels=!1,this.showNormals=!1,e.add(this.group)}toggle(){this.group.visible=!this.group.visible}setSurfels(e){this.showSurfels=e,this.group.visible=e||this.showNormals}setNormals(e){this.showNormals=e,this.group.visible=e||this.showSurfels}draw(e){if(this.group.clear(),!this.group.visible)return;let t=new Ca(.055,8,6);for(let n of e.surfels){if(!this.showSurfels&&n.type!==`wall`)continue;let e=new Yr({color:n.type===`wall`?15921382:6741503});e.color.offsetHSL(0,0,Math.min(Lf(n.irradiance)*.05,.25));let r=new K(t,e);if(r.position.set(n.pos.x,n.pos.y+.04,n.pos.z),this.group.add(r),this.showNormals){let e=new Fr().setFromPoints([r.position,new V(n.pos.x+n.normal.x*.35,n.pos.y+.04+n.normal.y*.35,n.pos.z+n.normal.z*.35)]);this.group.add(new Yi(e,new Vi({color:16770723})))}}}},Vp=.35,Hp=25,Up=8,Wp=4,Gp=.4,Kp=30,qp=.05,Jp=5,Yp=.25;function Xp(e){let t=[];for(let n=0;n<e.height;n++)for(let r=0;r<e.width;r++)e.grid.tileAt({x:r,z:n})||t.push(wf({x:r,z:n},e));return t}function Zp(e,t){let n=Math.hypot(e,t);return n<1e-6?{x:0,z:0}:{x:e/n,z:t/n}}var Qp=class{constructor(e,t=null){this.cell={x:0,z:0},this.spawnCell={x:0,z:0},this.position=new V,this.velocity=new V,this.radius=Vp,this.heldBlockId=null,this.ground=Pp(Op.SOLID),this.collisionBoxes=[],this.lastSolverCell=null,this.justRespawned=!1,this.mesh=new Mn,this.fallback=new Mn,this.robot=null,this.mixer=null,this.actions={},this.activeAction=null;let n=new K(new ma(.25,.55,4,10),e);n.position.y=.55;let r=new K(new Ca(.22,16,12),e);r.position.y=1.02;let i=new K(new pa(.28,.05,.04),new Yr({color:1053719}));i.position.set(0,1.04,-.2),this.fallback.add(n,r,i),this.mesh.add(this.fallback),this.shadow=new K(new ha(.42,28),new Yr({color:0,transparent:!0,opacity:.34,depthWrite:!1})),this.shadow.rotation.x=-Math.PI/2,this.shadow.position.y=.012,t&&this.setRobot(t)}setRobot(e){if(e?.scene){this.robot=e.scene,this.robot.scale.setScalar(Yp),this.robot.position.y=0,this.robot.rotation.y=Math.PI,this.robot.traverse(e=>{e.isMesh&&(e.castShadow=!1,e.receiveShadow=!1,e.material&&(e.material=e.material.clone(),e.material.roughness=Math.min(e.material.roughness??.7,.72),e.material.metalness=e.material.metalness??.05,e.material.color&&e.material.color.lerp(new G(14673892),.12).multiplyScalar(.72),e.material.emissive&&(e.material.emissive.set(3029046),e.material.emissiveIntensity=Math.max(e.material.emissiveIntensity??0,.04))))}),this.mesh.add(this.robot),this.fallback.visible=!1,this.mixer=new ss(this.robot),this.actions={};for(let t of e.animations??[])this.actions[t.name]=this.mixer.clipAction(t);this.playAction(`Idle`,0)}}playAction(e,t=.18){let n=this.actions[e]??this.actions.Idle??Object.values(this.actions)[0];!n||n===this.activeAction||(n.enabled=!0,n.reset().fadeIn(t).play(),this.activeAction&&this.activeAction.fadeOut(t),this.activeAction=n)}updateAnimation(e){if(!this.mixer)return;let t=Math.hypot(this.velocity.x,this.velocity.z);if(t>3.2&&this.actions.Running?this.playAction(`Running`):t>.25&&this.actions.Walking?this.playAction(`Walking`):this.playAction(`Idle`),this.activeAction){let e=this.activeAction.getClip().name===`Running`?.9:1;this.activeAction.timeScale=e}this.mixer.update(e/1e3)}reset(e){this.cell={...e.start},this.spawnCell={...e.start},this.heldBlockId=null,this.velocity.set(0,0,0);let t=xf(this.cell,e,0);this.position.set(t.x,0,t.z),this.mesh.position.copy(this.position),this.shadow.position.set(this.position.x,.012,this.position.z),this.ground=Pp(Op.SOLID),this.collisionBoxes=Xp(e),this.lastSolverCell={...this.cell},this.justRespawned=!1}deriveCell(e){let t=Cf(this.position.x,this.position.z,e);return this.cell={x:Math.max(0,Math.min(e.width-1,t.x)),z:Math.max(0,Math.min(e.height-1,t.z))},this.cell}pushOutOfWalls(){for(let e of this.collisionBoxes){let t=Math.max(e.minX,Math.min(this.position.x,e.maxX)),n=Math.max(e.minZ,Math.min(this.position.z,e.maxZ)),r=this.position.x-t,i=this.position.z-n,a=r*r+i*i;if(a<1e-8){let t=Math.abs(this.position.x-e.minX),n=Math.abs(e.maxX-this.position.x),o=Math.abs(this.position.z-e.minZ),s=Math.abs(e.maxZ-this.position.z),c=Math.min(t,n,o,s);c===t?r=-1:c===n?r=1:i=c===o?-1:1,a=1}if(a>=this.radius*this.radius)continue;let o=Math.sqrt(a),s=this.radius-o,c=r/o,l=i/o;this.position.x+=c*s,this.position.z+=l*s;let u=this.velocity.x*c+this.velocity.z*l;u<0&&(this.velocity.x-=u*c,this.velocity.z-=u*l)}}update(e,t,n,r){this.justRespawned=!1;let i=n.movementAxes(),a=r.getForwardXZ(),o=r.getRightXZ(),s=Zp(a.x*i.forward+o.x*i.right,a.z*i.forward+o.z*i.right),c=Math.min(e/1e3,qp)/Jp;for(let e=0;e<Jp;e++){let e=this.ground.supported!==!1,n=e?Hp:Up;this.velocity.x+=s.x*n*c,this.velocity.z+=s.z*n*c;let r=Math.exp(-(e?Wp:Gp)*c)-1;this.velocity.x+=this.velocity.x*r,this.velocity.z+=this.velocity.z*r,this.ground=Fp(this.ground,t,this.position.x,this.position.z,c*1e3),this.ground.supported?(this.position.y=0,this.velocity.y<0&&(this.velocity.y=0)):this.velocity.y-=Kp*c,this.position.x+=this.velocity.x*c,this.position.y+=this.velocity.y*c,this.position.z+=this.velocity.z*c,this.pushOutOfWalls(),this.position.y<=-25&&this.respawn(t)}return this.deriveCell(t),this.mesh.position.copy(this.position),this.shadow.position.set(this.position.x,.012,this.position.z),this.mesh.rotation.y=r.yaw,this.updateAnimation(e),this.mesh.visible=r.mode!==`fp`,!this.lastSolverCell||this.cell.x!==this.lastSolverCell.x||this.cell.z!==this.lastSolverCell.z}commitSolverCell(){this.lastSolverCell={...this.cell}}respawn(e){let t=xf(this.spawnCell,e,0);this.position.set(t.x,0,t.z),this.velocity.set(0,0,0),this.ground=Pp(Op.SOLID),this.deriveCell(e),this.mesh.position.copy(this.position),this.shadow.position.set(this.position.x,.012,this.position.z),this.justRespawned=!0}};function $p(e){return e?{map:e.basecolor??null,normalMap:e.normal??null,roughnessMap:e.roughness??null,aoMap:e.ao??null}:{}}function em(e={}){let t=$p(e.floor),n=$p(e.wall),r=$p(e.bounce);return{litTile:new Fa({...t,color:7830643,roughness:.78,metalness:.02,emissive:0}),voidTile:new Fa({...t,color:1120025,roughness:.95,transparent:!0,opacity:.62,emissive:0}),wall:new Fa({...n,color:2370092,roughness:.92}),bounce:new Fa({...r,color:15921382,roughness:.55,emissive:1118481}),socket:new Fa({...t,color:2831412,roughness:.8,emissive:3352832}),exit:new Fa({color:16770723,emissive:16762726,emissiveIntensity:1.2}),player:new Fa({color:14673892,roughness:.55,metalness:.1}),debug:new Yr({color:6741503})}}function tm(e){let t=hf[e]??hf.white;return new Fa({color:t.hex,emissive:t.hex,emissiveIntensity:e===`white`?1.6:2,roughness:.28})}var nm=class{constructor(e){this.block=e,this.colorKey=e.colorKey,this.mesh=new K(new pa(.52,.52,.52),tm(e.colorKey)),this.mesh.userData.blockId=e.id}update(e,t){if(this.block.state===`carried`)if(t.position)this.mesh.position.set(t.position.x,t.position.y+pf+.38,t.position.z);else{let n=xf(t.cell,e,pf+.38);this.mesh.position.set(n.x,n.y,n.z)}else{let t=xf(this.block.state===`placed`?this.block.cell:this.block.spawnCell,e,.36);this.mesh.position.set(t.x,t.y,t.z)}this.colorKey!==this.block.colorKey&&(this.mesh.material.dispose(),this.mesh.material=tm(this.block.colorKey),this.colorKey=this.block.colorKey),this.mesh.visible=this.block.on!==!1}};function rm(e){let t=[`white`,`red`,`green`,`blue`];e.colorKey=t[(t.indexOf(e.colorKey)+1)%t.length]}function im(e){return`${hf[e]?.icon??`◇`} ${e}`}var am=class{constructor(e){this.stack=[],this.onChange=e}snapshot(e){return{id:e.id,state:e.state,cell:e.cell?{...e.cell}:null,colorKey:e.colorKey,holder:e.holder??null}}restore(e,t){e.state=t.state,e.cell=t.cell?{...t.cell}:null,e.colorKey=t.colorKey,e.holder=t.holder}push(e,t,n){this.stack.push({id:e.id,before:t,after:n})}undo(e){let t=this.stack.pop();if(!t)return!1;let n=e.blocks.find(e=>e.id===t.id);return n?(this.restore(n,t.before),this.onChange?.(),!0):!1}clear(){this.stack.length=0}};function om(){return{root:document.getElementById(`hud`),level:document.getElementById(`levelLabel`),objective:document.getElementById(`objectiveLabel`),camera:document.getElementById(`cameraLabel`),gi:document.getElementById(`giLabel`),bounce:document.getElementById(`bounceLabel`),held:document.getElementById(`heldLabel`),foot:document.getElementById(`footLabel`),debug:document.getElementById(`debugPanel`)}}function sm(e,t){e.root.classList.toggle(`hidden`,!t.inGame),e.level.textContent=`Level ${t.levelIndex+1} / ${t.totalLevels}`,e.objective.textContent=t.level.objective,e.camera.textContent=t.cameraMode.toUpperCase(),e.gi.textContent=t.solveMode,e.bounce.textContent=_f[t.bounceViewIndex]??`FINAL`;let n=t.level.blocks.find(e=>e.id===t.player.heldBlockId);e.held.textContent=n?im(n.colorKey):`none`;let r=t.player.ground?.luminance??0,i=t.player.ground?.supported!==!1;e.foot.textContent=`${r.toFixed(2)} ${i?`solid`:`void`}`,e.debug.classList.toggle(`hidden`,!t.debugVisible),e.debug.textContent=t.debugText}function cm({onStart:e,onContinue:t}){let n=document.getElementById(`titleOverlay`),r=document.getElementById(`startButton`),i=document.getElementById(`levelOverlay`),a=document.getElementById(`overlayTitle`),o=document.getElementById(`overlayBody`),s=document.getElementById(`overlayButton`);return r.addEventListener(`click`,e),s.addEventListener(`click`,t),{title:n,modal:i,modalTitle:a,modalBody:o,modalButton:s}}function lm(e,t){e.title.classList.toggle(`hidden`,!t)}function um(e,t){e.modalTitle.textContent=`Level ${t.id} cleared`,e.modalBody.textContent=`${t.name} restored.`,e.modalButton.textContent=`Next`,e.modal.classList.remove(`hidden`)}function dm(e){e.modalTitle.textContent=`AFTERGLOW RESTORED`,e.modalBody.textContent=`All light paths are stable.`,e.modalButton.textContent=`Restart`,e.modal.classList.remove(`hidden`)}function fm(e){e.modal.classList.add(`hidden`)}function pm(e,t){lm(e,t===Au.TITLE)}var mm=[`01_title`,`02_l1_direct_before`,`03_l1_direct_after`,`04_l2_direct_only_fail`,`05_l2_gi_bounce_success`,`06_surfel_debug_points`,`07_bounce_pass_direct`,`08_bounce_pass_1`,`09_bounce_pass_2`,`10_color_mixing`,`11_color_gate_locked`,`12_color_gate_open`,`13_robot_animation`,`14_uv_normalmap_closeup`,`15_game_complete`];function hm({appState:e,levelIndex:t,solveMode:n,debugVisible:r}){let i=mm[0];return e===`GAME_COMPLETE`?i=`15_game_complete`:r?i=`06_surfel_debug_points`:t===0?i=`03_l1_direct_after`:t===1&&n===`DIRECT_ONLY`?i=`04_l2_direct_only_fail`:t===1?i=`05_l2_gi_bounce_success`:t===2?i=`09_bounce_pass_2`:t===3?i=`10_color_mixing`:t===4&&(i=`12_color_gate_open`),console.info(`[AFTERGLOW capture] ${i}.png`),i}function gm(e,t){let n=new Mn,r=e.width*X,i=e.height*X,a=new pa(r,of,.16),o=new pa(.16,of,i),s=-i/2-X*.5,c=i/2-X*.5,l=-r/2-X*.5,u=r/2-X*.5,d=new K(a,t.wall),f=new K(a,t.wall),p=new K(o,t.wall),m=new K(o,t.wall);return d.position.set(-X*.5,of/2,s),f.position.set(-X*.5,of/2,c),p.position.set(l,of/2,-X*.5),m.position.set(u,of/2,-X*.5),n.add(d,f,p,m),n}var _m=class{constructor(e,t){this.mesh=new Mn;let n=new K(new wa(.42,.035,10,36),t);n.rotation.x=Math.PI/2;let r=new K(new ga(.34,.34,.03,32),t);r.position.y=.04,this.mesh.add(n,r);let i=xf(e.exit,e,.08);this.mesh.position.set(i.x,i.y,i.z),this.mesh.scale.setScalar(X*.8)}reached(e,t){return Math.max(Math.abs(e.x-t.exit.x),Math.abs(e.z-t.exit.z))<=1}};function vm(e,t,n){let r=new pa(X,of,X);for(let i of t.interiorWalls){let a=new K(r,n.wall),o=xf(i,t,of/2);a.position.set(o.x,o.y,o.z),e.add(a)}}function ym(e,t,n){let r=new ga(.38,.38,.035,32),i=new pa(X*.82,1.1,X*.82),a=new Yr({color:65484,transparent:!0,opacity:0,depthWrite:!1}),o=[];for(let s of t.sockets){let c=new K(r,n.socket.clone()),l=xf(s.cell,t,.055);c.position.set(l.x,l.y,l.z),c.userData.socketId=s.id,e.add(c);let u=new K(i,a);u.position.set(l.x,.56,l.z),u.userData.socketId=s.id,u.userData.hitOnly=!0,e.add(u),o.push(c,u)}return o}function bm(e,t,n){let r=new pa(X*.86,1.05,.08);for(let i of t.bouncePanels)for(let a of i.cells){let o=new K(r,n.bounce.clone()),s=xf(a,t,.72);o.position.set(s.x,s.y,s.z),(i.normal===`+x`||i.normal===`-x`)&&(o.rotation.y=Math.PI/2),e.add(o)}}function xm(e,t,n){let r=wp(e),i=new Mn,a=new Map,o=new Map,s=e=>hf[e]?.hex??hf.white.hex;i.add(gm(r,n)),vm(i,r,n),bm(i,r,n);for(let e of r.grid.surfels){let t=Ip(e,n);a.set(e.id,t),i.add(t.mesh,t.edge)}let c=ym(i,r,n),l=[];for(let e of r.blocks){let t=new nm(e);t.update(r,{cell:r.start}),l.push(t),o.set(e.id,t.mesh),i.add(t.mesh)}let u=new _m(r,n.exit);return i.add(u.mesh),t.add(i),{level:r,visuals:{group:i,tileBySurfel:a,blockMeshes:o,blockViews:l,socketMeshes:c,exit:u,lights:Rp(t),paletteHex:s,debugText:``}}}var Sm=document.getElementById(`gameCanvas`),{renderer:Cm,scene:wm,resize:Tm,render:Em,setOutlineObjects:Dm}=af(Sm),Z=new Xf(Sm),Om=0,Q=null,km=new Qf(Sm,{onPointerDown(e){return Nu()!==Au.GAME||!Q||Z.isLocked||Fh()||!Z.shouldRequestLock()?!1:(e.preventDefault(),Z.lock())}}),Am=om(),jm=document.getElementById(`crosshair`),Mm=document.getElementById(`respawnFade`),Nm={anisotropy:Cm.capabilities.getMaxAnisotropy()},[Pm,Fm,Im,Lm]=await Promise.all([Ud(`floor_tile`,Nm),Ud(`wall_rock`,Nm),Ud(`bounce_panel`,Nm),Wd()]),Rm=em({floor:Pm,wall:Fm,bounce:Im}),$=new Qp(Rm.player,Lm),zm=new Bp(wm);wm.add($.mesh),wm.add($.shadow);var Bm=new ls,Vm=new B(0,0),Hm=new Ii(new V(0,1,0),0),Um=new V,Wm=new V,Gm=3.5,Km=X*1.35,qm=X*.75,Jm=X*1.7,Ym=Gm,Xm=.62,Zm=new K(new wa(.48,.025,8,48),new Yr({color:7143363,transparent:!0,opacity:.9,depthTest:!1}));Zm.visible=!1,Zm.rotation.x=-Math.PI/2,wm.add(Zm);var Qm=new K(new pa(.56,.56,.56),new Yr({color:7143363,transparent:!0,opacity:.48,depthWrite:!1}));Qm.visible=!1,wm.add(Qm);var $m=gf.indexOf(`GI`),eh=0,th=!1,nh=!1,rh=performance.now(),ih=null,ah=new URLSearchParams(window.location.search).has(`qa`),oh=new am(()=>lh()),sh=87.5,ch=cm({onStart(){mh()},onContinue(){Nu()===Au.GAME_COMPLETE?(Om=0,mh()):(fm(ch),Om+=1,Om>=$f.length?gh():ph(Om))}});function lh(){nh=!0}function uh(){Mm&&(Mm.classList.add(`respawnFade--active`),window.setTimeout(()=>Mm.classList.remove(`respawnFade--active`),sh))}function dh(){let e=_f[eh];return e===`DIRECT`?`DIRECT_ONLY`:e===`BOUNCE1`?`BOUNCE1`:e===`BOUNCE2`?`BOUNCE2`:gf[$m]}function fh(){if(Q){Dm([]),wm.remove(Q.visuals.group);for(let e of Q.visuals.lights)wm.remove(e);Q=null}}function ph(e){fh(),Om=e,Q=xm($f[e],wm,Rm),$.reset(Q.level),oh.clear(),$m=gf.indexOf(`GI`),eh=0,Q.level.playerCell={...$.cell},Q.level.mode=dh(),Z.setMode(`fp`),Z.setYawPitch(-Math.PI/2,-.78),Cp(Q.level,Q.level.mode),zp(Q.level,Q.visuals,16),Mu(Au.GAME),Z.snapTo(Q.level,$),lm(ch,!1),fm(ch)}function mh(){ph(0)}function hh(){Z.unlock(),Mu(Au.LEVEL_COMPLETE),um(ch,Q.level)}function gh(){Z.unlock(),Mu(Au.GAME_COMPLETE),dm(ch)}function _h(e){return oh.snapshot(e)}function vh(){for(let e of Q.visuals.blockViews)e.update(Q.level,$),e.block.state===`carried`&&Z.mode===`fp`&&(e.mesh.visible=!1)}function yh(e,t){return e.blocks.some(e=>e.state===`placed`&&bf(e.cell,t.cell))}function bh(e,t){let n=xf(e.cell,Q.level,0),r=Math.hypot(n.x-$.position.x,n.z-$.position.z);return r>t||!cp({x:$.position.x,z:$.position.z},n,Q.level.walls)?null:{pos:n,dist:r}}function xh(e,t=Gm,n=Xm){return Wm.set(e.x,e.y??0,e.z),Wm.distanceTo(Z.camera.position)>t||(Wm.project(Z.camera),Wm.z<-1||Wm.z>1)?!1:Math.hypot(Wm.x,Wm.y*.75)<=n}function Sh(e){return Q.visuals.socketMeshes.find(t=>t.userData.socketId===e.id&&!t.userData.hitOnly)??Q.visuals.socketMeshes.find(t=>t.userData.socketId===e.id)}function Ch(e){return Q.visuals.blockViews.find(t=>t.block.id===e.id)?.mesh??null}function wh(e,t=.2){let n=xf(e,Q.level,t);return new V(n.x,n.y,n.z)}function Th(){let e=null,t=1/0;for(let n of Q.level.blocks){let r=n.state===`pickup`?n.spawnCell:n.cell;if(n.state===`carried`||!r)continue;let i=xf(r,Q.level,.36),a=Math.hypot(i.x-$.position.x,i.z-$.position.z);a>Km||a>=t||a>qm&&!xh(i,Gm,.72)||(t=a,e=n)}if(!e)return null;let n=Ch(e),r=e.state===`pickup`?e.spawnCell:e.cell;return{type:`block`,block:e,object:n,point:n?.position?.clone()??wh(r,.45)}}function Eh(e=Jm){let t=null,n=1/0;for(let r of Q.level.sockets){if(yh(Q.level,r))continue;let i=bh(r,e);!i||i.dist>=n||(n=i.dist,t=r)}if(!t)return null;let r=Sh(t);return{type:`socket`,socket:t,object:r,point:r?.position?.clone()??wh(t.cell,.08)}}function Dh(){if(!Q)return null;if($.heldBlockId){let e=Eh();if(e)return e}if(!$.heldBlockId){let e=Th();if(e)return e}let e=[...Q.visuals.blockViews.filter(e=>e.block.state!==`carried`).map(e=>e.mesh),...Q.visuals.socketMeshes];Bm.setFromCamera(Vm,Z.camera),Bm.far=Gm;let t=Bm.intersectObjects(e,!1),n=null;for(let e of t){let t=e.object.userData.blockId;if(t){if($.heldBlockId)continue;let n=Q.level.blocks.find(e=>e.id===t);if(n&&n.state!==`carried`)return{type:`block`,block:n,object:e.object,point:e.point}}let r=e.object.userData.socketId;if(r){let t=Q.level.sockets.find(e=>e.id===r);if(t&&$.heldBlockId&&!yh(Q.level,t)&&bh(t,Gm))return{type:`socket`,socket:t,object:Sh(t),point:e.point};t&&!n&&(n={type:`socket`,socket:t,object:Sh(t),point:e.point})}}if($.heldBlockId&&Bm.ray.intersectPlane(Hm,Um)&&Um.distanceTo(Z.camera.position)<=Gm){let e=null,t=1/0;for(let n of Q.level.sockets){if(yh(Q.level,n))continue;let r=xf(n.cell,Q.level,0),i=Math.hypot(Um.x-r.x,Um.z-r.z);i<t&&i<=1.25*1.1&&(t=i,e=n)}if(e&&bh(e,Gm)){let t=Sh(e);return{type:`socket`,socket:e,object:t,point:Um.clone()}}}return $.heldBlockId?Eh()??Oh():Th()??n}function Oh(){let e=Z.getForwardXZ(),t=null,n=-1/0;for(let r of Q.level.sockets){if(yh(Q.level,r))continue;let i=bh(r,Ym);if(!i)continue;let a=i.pos;if(!xh(a,Ym))continue;let o=a.x-$.position.x,s=a.z-$.position.z,c=i.dist;if(c<.15)continue;let l=(o*e.x+s*e.z)/Math.max(c,1e-5);if(l<.18)continue;let u=l-c*.2;u>n&&(n=u,t=r)}if(!t)return null;let r=Sh(t);return{type:`socket`,socket:t,object:r,point:r?.position?.clone()??wh(t.cell,.08)}}function kh(){if(ih=Dh(),Dm(ih?.object&&!ih.object.userData.hitOnly?[ih.object]:[]),Zm.visible=!!ih,Qm.visible=!1,jm.classList.toggle(`crosshair--target`,!!ih),!ih)return;let e=ih.object?.position??ih.point;if(Zm.position.copy(e),Zm.position.y=Math.max(.12,e.y+.08),ih.type===`socket`){let t=!!Q.level.blocks.find(e=>e.id===$.heldBlockId)&&!yh(Q.level,ih.socket);Qm.visible=!0,Qm.material.color.set(t?7143363:16731192),Qm.position.copy(e),Qm.position.y=.42}}function Ah(){if(!Q)return;let e=Z.getForwardXZ(),t=$.position.x+e.x*X*1.2,n=$.position.z+e.z*X*1.2,r=Mp(Q.level,t,n);jm.classList.toggle(`crosshair--solid`,r>=sf),jm.classList.toggle(`crosshair--void`,r<sf)}function jh(e){return e?{x:e.x,y:e.y,z:e.z}:null}function Mh(){return ih?{type:ih.type,blockId:ih.block?.id??null,socketId:ih.socket?.id??null,point:jh(ih.point)}:null}function Nh(){ah&&(window.__AFTERGLOW_QA__={snapshot(){return{appState:Nu(),levelIndex:Om,modalHidden:ch.modal.classList.contains(`hidden`),modalTitle:ch.modalTitle.textContent,player:{cell:{...$.cell},position:{x:$.position.x,y:$.position.y,z:$.position.z},heldBlockId:$.heldBlockId,ground:{...$.ground}},camera:{mode:Z.mode,yaw:Z.yaw,pitch:Z.pitch,isLocked:Z.isLocked,pointerLockUnavailable:Z.pointerLockUnavailable,lockPending:Z.lockPending,position:jh(Z.camera.position)},target:Mh(),ui:{crosshairClassName:jm.className,ghostVisible:Qm.visible,targetHighlightVisible:Zm.visible,respawnFadeActive:Mm?.classList.contains(`respawnFade--active`)??!1},level:Q?{id:Q.level.id,name:Q.level.name,width:Q.level.width,height:Q.level.height,start:{...Q.level.start},exit:{...Q.level.exit},mode:Q.level.mode,blocks:Q.level.blocks.map(e=>({id:e.id,state:e.state,colorKey:e.colorKey,spawnCell:{...e.spawnCell},cell:e.cell?{...e.cell}:null})),sockets:Q.level.sockets.map(e=>({id:e.id,cell:{...e.cell}})),walkableCells:Q.level.grid.surfels.filter(e=>e.walkable).map(e=>({...e.cell}))}:null}}})}function Ph(){ih=Dh();let e=Q.level,t=e.blocks.find(e=>e.id===$.heldBlockId);if(!t){if(ih?.type!==`block`)return;let{block:e}=ih,t=_h(e);e.state=`carried`,e.cell=null,e.holder=`player`,$.heldBlockId=e.id;let n=_h(e);oh.push(e,t,n),lh();return}if(ih?.type!==`socket`||yh(e,ih.socket)){$.mesh.scale.set(1.12,.88,1.12),setTimeout(()=>$.mesh.scale.set(1,1,1),120);return}let{socket:n}=ih,r=_h(t);Ep(e,t.id,n.id),$.heldBlockId=null;let i=_h(t);oh.push(t,r,i),lh()}function Fh(){let e=Dh();return e?.type===`block`?!0:e?.type===`socket`&&!!$.heldBlockId&&!yh(Q.level,e.socket)}function Ih(){if(!(Nu()!==Au.GAME||!Q)){if(km.consumeAction(`mouse0`)&&Ph(),km.consumeAction(`e`)&&Ph(),km.consumeAction(`q`)){let e=Q.level.blocks.find(e=>e.id===$.heldBlockId);if(e){let t=_h(e);rm(e);let n=_h(e);oh.push(e,t,n),lh()}}km.consumeAction(`z`)&&oh.undo(Q.level)&&($.heldBlockId=Q.level.blocks.find(e=>e.state===`carried`)?.id??null,lh()),km.consumeAction(`r`)&&(Tp(Q.level),$.reset(Q.level),Q.level.playerCell={...$.cell},$m=gf.indexOf(`GI`),eh=0,Q.level.mode=dh(),Z.setMode(`fp`),oh.clear(),lh()),km.consumeAction(`g`)&&($m=$m===gf.indexOf(`GI`)?gf.indexOf(`DIRECT_ONLY`):gf.indexOf(`GI`),Q.level.mode=dh(),lh()),km.consumeAction(`b`)&&(eh=(eh+1)%_f.length,Q.level.mode=dh(),lh()),(km.consumeAction(`m`)||km.consumeAction(`p`))&&Z.togglePeek(),(km.consumeAction(`t`)||km.consumeAction(`o`)||km.consumeAction(`f`))&&Z.toggleThird(),km.consumeAction(`f1`)&&(th=!th),km.consumeAction(`v`)&&zm.setSurfels(!zm.showSurfels),km.consumeAction(`n`)&&zm.setNormals(!zm.showNormals),km.consumeAction(`c`)&&hm({appState:Nu(),levelIndex:Om,solveMode:Q.level.mode,debugVisible:th}),km.consumeAction(`escape`)&&(Z.unlock(),Mu(Au.TITLE),lm(ch,!0))}}function Lh(e){if(!Q)return;Ih();let t=$.update(e,Q.level,km,Z);$.justRespawned&&uh(),Q.level.playerCell={...$.cell},t&&($.heldBlockId&&lh(),$.commitSolverCell()),nh&&=(Q.level.playerCell={...$.cell},Cp(Q.level,Q.level.mode),!1),vh(),Z.update(Q.level,$),kh(),Ah(),zp(Q.level,Q.visuals,e),zm.group.visible=th||zm.showSurfels||zm.showNormals,zm.draw(Q.level);let n=Dp(Q.level,$.cell);n.reachedExit&&n.walkable&&$.position.y>=-.05&&!$.heldBlockId&&Nu()===Au.GAME&&(Om===$f.length-1?gh():hh()),sm(Am,{inGame:Nu()!==Au.TITLE,levelIndex:Om,totalLevels:$f.length,level:Q.level,cameraMode:Z.mode,solveMode:Q.level.mode,bounceViewIndex:eh,player:$,debugVisible:th,debugText:Q.visuals.debugText,appState:Nu()})}function Rh(e=performance.now()){let t=Math.min(e-rh,50);rh=e,Nu()!==Au.TITLE&&Lh(t),pm(ch,Nu()),Em(Z.camera),requestAnimationFrame(Rh)}window.addEventListener(`resize`,()=>Tm(Z.camera)),lm(ch,!0),Nh(),Rh();